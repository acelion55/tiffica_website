      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        ...
        >
          <div>
            <motion.p
              variants={fadeUp}
              className="text-xs uppercase text-primary font-black mb-3"
            >
              Partner With Us
            </motion.p>
            <motion.h1
            ...
            >
              Become a Kitchen Partner in Jaipur & Beawar
            </motion.h1>
            <motion.p variants={fadeUp} className="text-lg text-muted mb-6">
              Reach thousands of customers in your city. Flexible partnership
              options — Instant delivery, Bulk catering and Daily tiffin plans.
            </motion.p>

            <motion.div variants={fadeUp} className="flex gap-3 items-center">
              <a
                href="#partner-form"
                className="bg-primary text-white px-5 py-3 rounded-lg font-bold"
              >
                Partner With Us
              </a>
              <a
                href="tel:+919983745802"
                className="text-sm text-foreground/70"
              >
                Call us: +91 9983745802
              </a>
            </motion.div>
            ...
            >
              <div className="p-4 border rounded-lg text-center">
                ...
                <p className="text-xs text-muted">
                  Daily orders from students, offices and households.
                </p>
              </div>
              <div className="p-4 border rounded-lg text-center">
                ...
                <p className="text-xs text-muted">
                  Integrated with our delivery network for fast orders.
                </p>
              </div>
              <div className="p-4 border rounded-lg text-center">
        ...
        <motion.section variants={fadeUp} className="mt-16">
          <motion.h2 variants={fadeUp} className="text-2xl font-black mb-4">
            How it works
          </motion.h2>
          <motion.div variants={fadeUp} className="grid sm:grid-cols-3 gap-6">
            <div className="p-6 border rounded-lg">
              ...
              <p className="text-sm text-muted">
                Submit basic details using the form — name, phone, address and
                services.
              </p>
            </div>
            <div className="p-6 border rounded-lg">
              ...
              <p className="text-sm text-muted">
                We verify your kitchen and set up your menu and delivery
                options.
              </p>
            </div>
            <div className="p-6 border rounded-lg">
              ...
              <p className="text-sm text-muted">
                Begin receiving orders through the app and web — get paid on
                time.
              </p>
            </div>
          </motion.div>
        ...
        <motion.section variants={fadeUp} className="mt-16">
          ...
          <motion.ul variants={fadeUp} className="grid sm:grid-cols-2 gap-4">
            <li className="p-4 border rounded-lg">
              Access to a growing customer base in Jaipur & Beawar
            </li>
            <li className="p-4 border rounded-lg">
              Flexible service options: Instant, Bulk & Daily Tiffin
            </li>
            <li className="p-4 border rounded-lg">
              Marketing support and listing promotions
            </li>
            <li className="p-4 border rounded-lg">
        ...
        <motion.section variants={fadeUp} className="mt-16">
          ...
          <motion.ul
            variants={fadeUp}
            className="list-disc pl-6 text-sm text-muted"
          >
        ...
        <motion.section variants={fadeUp} className="mt-16">
          ...
          <motion.div variants={fadeUp} className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted">
                No upfront fee — we take a small commission per order. Specifics
            ...
            <div>
              ...
              <p className="text-sm text-muted">
                Yes — choose the services (Instant, Bulk, Daily Tiffin) that
                match your kitchen.
              </p>
            </div>
          </motion.div>
